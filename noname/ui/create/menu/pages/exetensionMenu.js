	...
	return ${str} 
      ...
      var dash1 = (function() {
        ...
        page2.reset = function(name) {
          resetEditor();
          if (page2.imagePromises == null) {
            page2.imagePromises = [];
          } else {
            page2.imagePromises.length = 0;
          }
          ...
          if (lib.extensionPack[name]) {
            ...
            page2.content.image = {};
            for (const id in page2.content.pack.character) {
              const file = id + ".jpg";
              const url = lib.assetURL + "extension/" + name + "/" + file;
              createButton(id, url);
              page2.imagePromises.push(
      ...
      var dash2 = (function() {
        ...
        page2.reset = function(name) {
          ...
          if (lib.extensionPack[name]) {
            ...
            for (const id in page2.content.pack.card) {
              const fullskin = page2.content.pack.card[id].fullskin ? true : false;
