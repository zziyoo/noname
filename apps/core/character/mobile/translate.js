...
const translates = {
	...
	reliangyin: "良姻",
	reliangyin_info: "①当有牌被置于武将牌上时，你可令一名角色摸一张牌；②当任意角色获得一名角色武将牌上的牌时，你可令一名角色弃置一张牌。③每轮结束时，你可令本轮唯一成为“良姻”目标的角色回复1点体力，或令本轮唯一未成为“良姻”目标的角色失去1点体力。",
	rekongsheng: "箜声",
	rekongsheng_info: "准备阶段、当你失去体力时或者当你回复体力时，你可以将当前回合角色的任意张牌置于武将牌上。若如此做，该角色的结束阶段，你可以使用其中一张牌，然后其获得其余的牌。",
	re_yanyan: "手杀界严颜",
	re_yanyan_prefix: "手杀界",
	rejuzhan: "拒战",
	rejuzhan_info: `转换技，阳：当你或者此状态下第三次有角色成为【杀】的目标后，你可以与此【杀】的使用者各摸一张牌，然后其本回合不能对你使用牌；阴：当你或者此状态下第三次有角色使用【杀】指定目标后，你可以获得此【杀】的目标角色一张牌，然后你本回合不能对其使用牌。${get.poptip("rule_chengshi")}：你于出牌阶段内使用【杀】的次数+1，且此【杀】结算完毕后，你获得之。`,
	mb_gaoxiang: "手杀高翔",
	...
	mbshefu: "设伏",
	mbshefu_info: "①结束阶段，你可以记录一个未被记录的非装备牌名并扣置一张牌，称为“伏兵”；②你的回合外，当其他角色使用牌时，你可以移去一张记录名称相同的“伏兵”，令此牌无效（若此牌有目标角色则改为取消所有目标），然后你摸一张牌。",
	mbbenyu: "贲育",
	mbbenyu_info: "当你受到伤害后，若你的手牌数：小于X，你可将手牌摸至X张（至多摸五张）；大于X，你可弃至少X+1张手牌，对伤害来源造成1点伤害（x为伤害来源的手牌数）。",
	mb_dongbai: "手杀董白",
	...
	mbjieyuan: "竭缘",
	mbjieyuan_info: "你造成伤害时，你可以选择一项：1、弃置一张黑色牌，令此伤害+1；2、从牌堆中获得一张黑色牌。<br>你受到伤害时，你可以选择一项：1、弃置一张红色牌，令此伤害-1；2、从牌堆中获得一张红色牌。<br>背水：删除另一个时机的效果，将伤害的增减、获得牌的数量改为2，然后失去背水选项。",
	mbfenxin: "焚心",
	mbfenxin_info: "被你杀死的角色亮出其身份牌前，你可选择一项：1、其亮出身份牌后，若与你身份不同，你获得其武将牌上所有技能（限定技、觉醒技、使命技、主公技、持恒技除外）；2、与其交换身份牌（你的身份牌非明置时方可选择）。",
};
