...
const translates = {
	...
	tw_yj_fazheng: "TW☆法正",
	tw_yj_fazheng_prefix: "TW|☆",
	cangjia: "藏铗",
	cangjia_info: "锁定技，你于出牌阶段外获得牌时，记录此牌花色；当你成为其他角色使用未记录花色牌的目标后，除非其弃置一张牌，否则此牌对你无效。",
	duohui: "堕洄",
	...
	twzhian: "治暗",
	twzhian_info: "每回合限一次。一名其他角色使用装备牌或延时锦囊牌后，你可选择：⒈弃置位于场上的此牌。⒉弃置一张手牌并获得位于场上的此牌。⒊对其造成1点伤害。",
	...
	tw_caozhao: "曹肇",
	twfuzuan: "复纂",
	twfuzuan_info: "出牌阶段限一次/当你受到伤害后/当你对其他角色造成伤害后，你可选择一名拥有转换技的角色，变更其的一个转换技的状态。",
	twchongqi: "宠齐",
	...
	twjichou: "急筹",
	twjichou_info: "①每回合限一次。你可以视为使用一张未被〖急筹①〗记录过的普通锦囊牌并记录此牌。②你无法响应或{使用对应实体牌包含你的手牌的}〖急筹①〗记录过的锦囊牌。③出牌阶段限一次。你可将手牌中任意张〖急筹①〗记录过的锦囊牌交给一名其他角色。",
	twjilun: "机论",
	...
	twduoren: "夺刃",
	twduoren_info: "一名其他角色死亡后，若你对其造成过伤害或其对你造成过伤害，则你可以失去所有非自己武将牌上的技能，然后获得其武将牌上所有技能（主公技、隐匿技除外）。",
	tw_yangang: "严纲",
	twzhiqu: "直取",
	...
	twlifeng: "砺锋",
	twlifeng_info: "出牌阶段，你可以弃置两张牌，对一名与你距离为X的角色造成1点伤害（X为两牌点数之差），若你以此法弃置了非“逆涡”牌，你摸一张牌。",
	old_twlifeng: "砺锋",
	...
	twchengbian: "乘变",
	twchengbian_info: "准备阶段和结束阶段，你可以摸一张牌并与一名角色延时拼点，然后视为对其使用一张【决斗】，直到此【决斗】结算结束，此【决斗】结算过程中各限X次（X为各自手牌数的一半，向下取整），当你或目标角色需要打出【杀】响应此【决斗】时，可以将一张手牌当【杀】打出。结算后公开结果，拼点赢的角色将手牌摸至体力上限。你的拼点牌点数+X（X为当前游戏轮数且至多为4）。",
	tw_sxrm_caocao: "TW疑曹操",
	tw_sxrm_caocao_prefix: "TW|疑",
	twkuxin: "枯心",
	twkuxin_info: "你受到伤害后，可以令所有其他角色依次选择展示任意张手牌，然后你获得所有角色展示的牌或一名角色未展示的手牌并展示之，若你未以此法获得♥牌，你弃置这些牌。",
	twsigu: "似故",
	twsigu_info: `出牌阶段限一次，你可令一名其他角色进行判定，令其获得${["zhichi", "reganglie", "refankui", "new_reyiji", "oljieming", "fangzhu", "shibei", "rechengxiang", "zhiyu", "jilei", "benyu", "chouce", "new_wuhun"].map(skill => get.poptip(skill)).join("")}中的第X个技能（X为判定点数）。若如此做，你对其造成两次1点伤害，然后其失去以此法获得的技能。`,
	twkuimu: "窥目",
	twkuimu_info: "每轮限一次，当一名角色的判定牌生效前，你可观看其所有手牌并选择一张代替之。若花色不同，你受到其造成的1点伤害。",
	tw_sxrm_fuhuanghou: "TW疑伏寿",
	tw_sxrm_fuhuanghou_prefix: "TW|疑",
	twmitu: "密图",
	twmitu_info: "准备阶段，你可以令至多三名已受伤角色各摸一张牌并展示之，然后令这些角色依次选择是否与你指定的另一名角色拼点，拼点赢的角色视为对没赢的角色使用一张【杀】。每有一名角色未用以此法展示的牌进行拼点，你减少1点体力上限。",
	twqianliu: "潜流",
	twqianliu_info: "与你距离1以内的角色成为【杀】的目标后，你可以观看牌堆底三张牌并以任意顺序置于牌堆顶或牌堆底；若这些牌花色均相同或均不相同，你可以展示并获得这些牌。",
};
