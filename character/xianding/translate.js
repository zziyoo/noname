...
const translates = {
	...
	dcxianfu: "娴辅",
	dcxianfu_info: "每回合限一次，当你成为牌的目标时，你可以跳过你下个除准备阶段和结束阶段外的一个阶段，令此牌对你无效。然后你与“明节”角色互相观看对方的手牌并可获得其中至多三张牌。",
	dc_sb_guanyu: "新杀谋关羽",
	...
	dcxiankuang: "贤贶",
	dcxiankuang_info: "有角色非因使用失去基本牌进入弃牌堆后，你可废除一个装备栏并选择一项发动：1.获得其中的第一张牌；2.令此角色摸你废除的装备栏数张牌。（单回合因此技能获得牌累计大于1张时此技能失效至本回合结束）",
	liuxuan: "刘璿",
	mogui: "漠规",
	...
	dc_huanhuaijin: "环怀瑾",
	dclianyou: "怜幼",
	dclianyou_info: "每轮每项限一次，你的回合开始时或受到伤害后可选择一项：1.令一名角色回复2点体力；2.令一名角色随机使用牌堆或弃牌堆中两张装备牌；3.摸三张牌并可以交给一名其他角色三张牌。",
	dccili: "慈厉",
	dccili_info: "每轮开始时，你可记录一名角色的体力值。直到下回合结束，若其使用的牌数：小于记录值，你可以令一名角色弃置记录值张牌；不小于记录值，你可以令一名角色摸记录值张牌。",
	caohua: "曹华",
	caiyi: "彩翼",
	...
	fugan: "傅干",
	qiaojian: "巧谏",
	qiaojian_info: "出牌阶段每名角色限一次，你选择一名其他角色，双方同时弃置任意张牌，若你弃置牌点数之和较大，你回复1点体力并选择一项：1、其下个回合首次使用【杀】与锦囊牌可各额外结算一次；2、其下个回合不可使用伤害牌。否则，你获得双方弃置牌并不计入手牌上限。",
	qiaojian_tag: "巧谏",
	xicha: "析察",
