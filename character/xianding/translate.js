...
const translates = {
	...
	dcyinzhi: "阴鸷",
	dcyinzhi_info: "出牌阶段限一次，你可以选择一名其他角色并摸X张牌，该角色所有非锁定技失效直至其回合开始，且在此期间，其每次使用或打出手牌后你摸X张牌（X为本局游戏你对其发动〖阴鸷〗的次数且至多为3）。然后其回合内只能使用或打出本回合获得的牌，若其对你造成伤害，则此效果消失且X对其重置。",
	dckeming: "刻名",
	...
	dc_xia_wangyue: "王越",
	wudou: "武斗",
	wudou_info: "每回合每项限一次：1.其他角色对你使用伤害牌结算后，你可以视为对其使用一张【决斗】；2.其他角色使用【决斗】指定目标后，若目标不为你，你可获得此牌并将目标更改为你。",
	jiandao: "剑道",
	jiandao_info: "锁定技。①你的伤害锦囊牌视为【决斗】。②目标含有你的伤害牌结算后你摸一张伤害牌（不计次数）。③你造成渠道为【决斗】的伤害后你下次使用【杀】不可响应。④你每造成两次伤害，本局游戏你的【杀】伤害+1并选择任意张手牌替换为伤害牌。",
	shie: "史阿",
	liren: "砺刃",
	liren_info: "锁定技。①你的攻击范围始终为2。②当【杀】造成伤害后，你获得此【杀】。③当【杀】被抵消后，你摸一张牌。④每回合至多以此法获得3张牌。",
	sejianchu: "剑出",
	...
	dcxiankuang: "贤贶",
	dcxiankuang_info: "有角色非因使用失去基本牌进入弃牌堆后，你可废除一个装备栏并选择一项发动：1.获得此牌；2.令此角色摸你废除的装备栏数张牌。（单回合因此技能获得牌累计大于1张时此技能失效至本回合结束）",
	liuxuan: "刘璿",
	mogui: "漠规",
	mogui_info: "你的回合内，你可以于对应阶段开始时执行并移除对应项：1.判定阶段，令一名角色回复1点体力并弃置判定区里的所有牌；2.摸牌阶段，令一名角色摸牌阶段摸牌数和使用【杀】的次数上限+1；3.弃牌阶段，弃置至多五张牌，令一名角色手牌上限+1并摸等量张牌。",
	zunjian: "遵谏",
	...
	dc_huanhuaijin:"环怀瑾",
	dclianyou:"怜幼",
	dclianyou_info:"每轮每项限一次，你受到伤害后可选择一项：1.令一名体力值最少的角色回复2点体力；2.令一名装备区牌最少的角色随机使用牌堆或弃牌堆中两张装备牌；3.摸三张牌并可以交给一名手牌数最少的其他角色三张牌。",
	dccili:"慈厉",
	dccili_info:"每轮开始时，你可记录一名角色的体力值，其下回合结束时，若其此回合内使用的牌数：小于记录值，你可以令一名角色随机弃置记录值张牌；不小于记录值，你可以令一名角色摸记录值张牌。",
	caohua: "曹华",
	caiyi: "彩翼",
	...
	dcsbmingshi: "明势",
	dcsbmingshi_info: "摸牌阶段结束时，你可以摸两张牌，然后你展示三张手牌并令一名其他角色选择获得其中的一张牌。",
	dcsbmengmou: "盟谋",
	dcsbmengmou_info: "转换技。①游戏开始时，你可以转换此技能状态；②每回合每项各限一次，当你得到其他角色的手牌后，或其他角色得到你的手牌后：阳，你可以令该角色使用至多X张【杀】，且其每以此法造成1点伤害，其回复1点体力；阴，你可令该角色打出至多X张【杀】，然后其失去Y点体力。（X为你的体力上限，Y为X-其打出【杀】数）",
	dc_sb_zhouyu: "新杀谋周瑜",
	...
	dcsbyaozuo: "邀作",
	dcsbyaozuo_info: `出牌阶段限一次，你令所有其他角色同时选择是否交给你一张牌，未交给你牌的角色，本回合你对其下次造成伤害+1；然后你令最快交给你牌的角色选择另一名其他角色，你对该角色发动一次${get.poptip("dcsbzhuanwen")}。`,
	dcsbzhuanwen: "撰文",
	...
	v_dongzhuo_prefix: "威",
	dcguangyong: "犷勇",
	dcguangyong_info: "锁定技。当你使用牌指定第一个目标后，若目标：包含你，你增加1点体力上限（至多加至8）；包含其他角色，你减少1点体力上限（至多减至1）并获得其中一名目标角色一张牌。",
	dcjuchui: "据陲",
	...
	dcningzhun: "凝准",
	dcningzhun_info: "每回合每项限一次，你每回合使用的第偶数张牌结算结束后，可选择一项：1.攻击范围-1；2.攻击范围+1；3.移动场上一张牌。若本回合你执行了其中两个选项，此技能视为未发动过。",
	liufuren: "刘懿君",
	dcdulu: "妒戮",
